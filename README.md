...
The piece is illustrated throughout with a fire-and-ice visual theme and draws on literary and mythic parallels (Medusa, the masked face) alongside the clinical research.

## License

This project is released under the MIT License — see [LICENSE](LICENSE) for details.

Thoughts by Setvin Noether ([@SauerNinja](https://github.com/SauerNinja)). If you reuse or build on this piece, please credit accordingly.
